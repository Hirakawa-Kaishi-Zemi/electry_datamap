...
os.chdir("/chubu_download/202308_power_usage/")
os.makedirs("/chubu_download/2023_08", exist_ok=True)
...
#予測値と使用率、供給力想定値を削除
        df2 = df.drop([3,4,5],axis=1)

#最大使用率以降の行を削除(38行目から)
        df3 = df2.drop([i for i in range(38,343)], axis=0)#delete col
...
#行番号の直し
        ...
        os.chdir("/chubu_download/2023_08")
#データの書き出し
